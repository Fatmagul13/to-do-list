...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kulAdi= (EditText) findViewById(R.id.kullaniciAdiKayit);
        kulSifre= (EditText) findViewById(R.id.SifreKayit);
        ...
        kayit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String email = kulAdi.getText().toString();
                String parola = kulSifre.getText().toString();
    ...
    private void getUserInfoAndRegister() {
        userEmail = kulAdi.getText().toString().trim();
        userPassword = kulSifre.getText().toString().trim();

        String userConfirmPassword = kulSifre.getText().toString();
