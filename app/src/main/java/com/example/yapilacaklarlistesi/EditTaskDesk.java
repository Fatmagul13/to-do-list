...
public class EditTaskDesk extends AppCompatActivity {
    ...
    String keykeydoes = Integer.toString(doesNum);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleDoes.setText( getIntent().getStringExtra( "baslik" ) );
        descDoes.setText( getIntent().getStringExtra( "aciklama" ) );
        dateDoes.setText( getIntent().getStringExtra( "tarih" ) );
